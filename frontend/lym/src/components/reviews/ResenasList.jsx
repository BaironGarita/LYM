...
const ResenasList = () => {
  ...
  const fetchResenas = async () => {
    try {
      setLoading(true);
      // Solicitar más reseñas cambiando el límite por defecto
      const response = await fetch("http://localhost:8000/?url=resenas&limit=100");
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <div className="flex items-center gap-1">
                <StarRating rating={Number(resena.valoracion)} readonly />
