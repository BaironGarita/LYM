...
const PromotionModal = ({
  ...
  const validate = () => {
    ...
    if (!formData.fecha_inicio) {
      newErrors.fecha_inicio = t(
        "admin.promotions.validation.startDateRequired"
      );
    }
    ...
    if (!formData.aplica_a_id) {
      const validationKey =
        formData.tipo === "categoria" ? "categoryRequired" : "productRequired";
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-4">
              ...
              >
                ...
                <SelectContent>
                  <SelectItem value="categoria">
                    {t("admin.promotions.category")}
                  </SelectItem>
                  <SelectItem value="producto">
                    {t("admin.promotions.product")}
                  </SelectItem>
                </SelectContent>
              </Select>
            </div>
            <div>
              <Label htmlFor="aplica_a_id">
          ...
          <div className="flex justify-end gap-3 pt-4">
            ...
            <Button type="submit" disabled={isPastPromotion}>
              {editingPromotion
                ? t("admin.promotions.saveChanges")
                : t("admin.promotions.create")}
            </Button>
          </div>
        </form>
