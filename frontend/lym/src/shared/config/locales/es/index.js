  ...
  translation: {
    ...
    pages: {
      home: {
        ...
        heroSubtitle: "Explora nuestras colecciones exclusivas y descubre las prendas perfectas que se adaptan a tu estado de ánimo.",
      ...
      products: {
        ...
        tryAnotherCategory: "Intenta seleccionar otra categoría o revisa más tarde.",
        errorLoading: "No se pudieron cargar los productos.",
        errorLoadingProducts: "Error al cargar los productos.",
        noProductsInCategory: "No se encontraron productos para la categoría seleccionada."
      },
      offers: {
        ...
        noCategoryOffers: "No hay ofertas para esta categoría. Prueba con otra categoría.",
        checkBackSoon: "Vuelve pronto para descubrir nuevas ofertas increíbles",
        dontMiss: "¡No te pierdas estas ofertas!",
        offersChangeRegularly: "Nuestras ofertas cambian regularmente. Sigue visitando para descubrir nuevos productos con descuentos increíbles. ¡Ahorra en tus marcas favoritas!",
